...
public class Util {
	...
	public static final String MENSAJE_REG_DELETEPRO = "Se elimino correctamente.";
	public static final String MENSAJE_ACT_ERROR_DELETEPRO= "No se elimino, probablemente este producto tenga un comprobante";
